...
#include "contrib_ops/cuda/transformers/fastertransformer/kernels/online_softmax_beamsearch_kernels.h"
                                             ...
                                             const std::vector<Tensor>* input_tensors)
{
    ...
    const int id_offset = (step * batch_size + local_batch_size * ite) * gsl::narrow_cast<int>(beam_width_);
    invokeTopkSoftMax((const T*)input_tensors->at(0).data,
                      ...
                      gsl::narrow_cast<int>(topk_softmax_workspace_size_),
                      local_batch_size,
