...
#define BINARY_ELEMENTWISE_IMPL_DECLARATION(name) \
  template <typename T>                           \
  void Impl_##name(BINARY_ELEMENTWISE_IMPL_ARGUMENTS_DECLARATION(T, T, T))
...
#define BINARY_ELEMENTWISE_IMPL_DECLARATION_T1(name) \
  ...
  void ImplT1_##name(BINARY_ELEMENTWISE_IMPL_ARGUMENTS_DECLARATION(T, T, T1))

    BINARY_ELEMENTWISE_IMPL_DECLARATION_T1(Pow);

#define BINARY_ELEMENTWISE_IMPL_DECLARATION_T2(name) \
  template <typename T, typename T1, typename T2>    \
  void ImplT2_##name(BINARY_ELEMENTWISE_IMPL_ARGUMENTS_DECLARATION(T, T1, T2))
